...
```bash
$ git clone git@github.com:finalgene/docker-hub-github-release.git
```

- Or via HTTPS:

```bash
$ git clone https://github.com/finalgene/docker-hub-github-release.git
```
...
2. Fork the repository (http://github.com/finalgene/docker-hub-github-release)
3. Clone the canonical repository locally and enter it.

```bash
$ git clone git://github.com/finalgene/docker-hub-github-release.git
$ cd docker-hub-github-release
```

4. Add a remote to your fork; substitute your GitHub username in the command below.

```bash
$ git remote add {username} git@github.com:{username}/docker-hub-github-release.git
$ git fetch {username}
```
...
To ssh://git@github.com/{username}/docker-hub-github-release.git
